// // first created this to check whether it works or not

// "use client"
// import { login, authenticate, userName, logout } from '@/lib/actions/auth'
...
//                     <p className='text-2xl text-center text-white font-bold'>User is Loged in as {Name}</p>
//                     <button onClick={() => { logout() }} className="mt-6 my-4 px-8 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150">Sign out</button>
//                 </div>
//             ) : (
...
//                         {/* <span>
//                             <img src="tea.gif" alt='tea.gif' width={150} className="mx-auto" />
//                         </span> */}

//                         <div className="mt-5 space-y-2">
//                             <h3 className="text-white text-2xl font-bold sm:text-3xl">Log in to your account</h3>
//                             <p className="">Don't have an account? <a href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-white">Sign up</a></p>
//                         </div>
//                     </div>
//                     <form
...
//                         </button>
//                         {/* Github Login button */}
//                         <button onClick={() => { login() }} className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
//                             <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//                     </div>
//                     <div className="text-center">
//                         <a href="javascript:void(0)" className="text-indigo-600 hover:text-white">Forgot password?</a>
//                     </div>
//                 </div>
//             </div>)}
//         </div>
